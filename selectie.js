...
contact.onclick= function(){window.open("https://www.instagram.com/stefanlv_mnk/");}
}
 if (selectie==2){
 ...
 contact.onclick= function(){window.open("https://www.instagram.com/catalin_mnk/");}}
 if (selectie==3){
 ...
 contact.onclick= function(){window.open("https://www.instagram.com/razvan_mnk/");}}
 if (selectie==4){
    ...
    contact.onclick= function(){window.open("https://www.instagram.com/_denis.st/");}}
if (selectie==5){
    ...
    contact.onclick= function(){window.open("https://www.instagram.com/cosmin540/");}}
 selectie++;
 if (selectie==6)
 selectie=1;
}